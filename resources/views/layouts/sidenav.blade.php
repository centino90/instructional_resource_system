    ...
    <div class="mt-3">
        ...
        <ul class="nav nav-pills nav-flush persist-default flex-column components mb-5">
            ...
            @if (auth()->user()->isAdmin())
                <li class="nav-item px-2">
                    <a href="{{ route('admin.users.index') }}" class="nav-link py-2 " title=""
                        data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Content Management">
            ...
            @if (auth()->user()->isInstructor() ||
                ...
                <li class="nav-item px-2">
                    <a href="{{ route('storage.show', [auth()->id(), 'leftPath' => 'users/' . auth()->id()]) }}"
                        class="nav-link py-2 position-relative" title="" data-bs-toggle="tooltip"
            ...
            <li class="nav-item px-2">
                <a href="{{ route('user.notifications', auth()->id()) }}" class="nav-link py-2 position-relative"
                    title="" data-bs-toggle="tooltip" data-bs-placement="right"
                    data-bs-original-title="My notifications">
                    <span>
