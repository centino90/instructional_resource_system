               ...
               <div class="row g-3">
                  <div class="col-12">
                     <x-real.card>
                        ...
                        <x-slot name="body">
                           <x-real.form action="{{ route('admin.programs.update', $program) }}" method="PUT">
                              <x-real.input name="code" value="{{ $program->code }}">
                                 <x-slot name="label">Code</x-slot>
                              </x-real.input>

                              <x-real.input name="title" value="{{ $program->title }}">
                              ...
                              <x-real.input name="is_general" type="select">
                                 ...
                                 <x-slot name="options">
                                    <option {{ $program->is_general == false ? 'selected' : '' }} value="0">No
                                    </option>
                                    <option {{ $program->is_general == true ? 'selected' : '' }} value="1">Yes
                                    </option>
                                 </x-slot>
                              </x-real.input>
