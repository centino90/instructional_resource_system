      ...
      <div class="col-8">
         ...
         @if (empty($verbs))
            <x-real.card>
               ...
               <x-slot name="body">
                  <x-real.no-rows>
                     <x-slot name="label">No syllabus checking standard was added yet</x-slot>
                  </x-real.no-rows>
               </x-slot>
            </x-real.card>
         @else
                  ...
                  <ul class="nav nav-pills justify-content-end gap-3" id="syllabusSubmitTab" role="tablist">
                     ...
                     <li class="nav-item p-0" role="presentation">
                        <button class="storageUploadStandaloneBtn nav-link py-0 text-dark rounded-0"
                           id="syllabusSubmitUrlTab" data-bs-toggle="pill" data-bs-target="#syllabusSubmitUrlTabpane"
                  ...
                  <div class="dropzone">
                     <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="syllabusSubmitFormTabpane" role="tabpanel">
                           <x-real.form action="{{ route('syllabi.upload', $course) }}" class="submit-resource-form"
                              id="syllabusForm">
                        ...
                        <div class="tab-pane fade" id="syllabusSubmitUrlTabpane" role="tabpanel">
                           <x-real.form action="{{ route('syllabi.uploadByUrl', $course) }}" id="storeByUrlForm"
