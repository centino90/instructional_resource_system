<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a class="fw-bold" href="{{ route('instructor.course.show', $resource->course->id) }}"><- Go back</a></li>
                                            ...
                                            <li class="dropdown-item p-0">
                                                <ul class="list-group" style="min-width: 300px">
                                                    <li class="list-group-item">
                                                        ...
                                                        <a href="{{route('instructor.resource.preview', $resource->id)}}"
