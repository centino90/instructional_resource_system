                                ...
                                <div class="col-12 col-lg-4">
                                    ...
                                    <ul class="shadow list-group mt-3">
                                        <li
                                            ...
                                            <strong id="submit-general-tab-logs-count"></strong>
                                            <ul id="submit-general-tab-logs" class="w-100 list-group mt-3">
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-12 col-lg-8">
                                    <ul class="nav nav-tabs d-none" id="generalSubmitTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                    ...
                                    <div class="tab-content" id="generalSubmitTabcontent">
                                        ...
                                        <div class="tab-pane fade" id="generalSubmitPreview" role="tabpanel">
                                            <header class="fs-5 fw-bold">
                                                <a class="me-3" href="#" id="generalSubmitPreviewReturn">
                                                    <- Upload </a>
                                                        Preview
                                            </header>

                                            <div class="border rounded mt-3 p-3" id="generalSubmitPreviewContent">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <li class="dropdown-item p-0">
                                                                <ul class="list-group" style="min-width: 300px">
                                                                    ...
                                                                    <li class="list-group-item">
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <button data-preview-id="${item.id}" data-preview-mimetype="${item.mimetype}" class="submitGeneralPreviewBtns w-100 btn btn-light border text-primary fw-bold">
                                                                                    Preview
                                                                                </button>
                                                                            </div>
                                                                            <div class="col-6">
                    ...
                    .done(function(data) {
                        ...
                        $('#submit-general-tab-logs').delegate('.submitGeneralPreviewBtns', 'click',
                            function(event) {
                                ...
                                const mimetypes = @json(config('app.pdf_convertible_mimetypes'));
                                console.log($(event.target).attr('data-preview-mimetype'))
                                console.log(mimetypes)
                                if ($.inArray($(event.target).attr('data-preview-mimetype'),
                                        mimetypes) == -1) {
                                    $.ajax({
                                            method: "GET",
                                            url: previewUrl
