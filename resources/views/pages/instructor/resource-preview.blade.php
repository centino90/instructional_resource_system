<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a class="fw-bold"
                href="{{ route('instructor.resource.show', $resource->id) }}">
                <- Go back</a>
        </li>
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('instructor.course.index') }}">Courses</a></li>
        <li class="breadcrumb-item"><a
                href="{{ route('instructor.course.show', $resource->course->id) }}">{{ $resource->course->code }}</a>
        </li>
        <li class="breadcrumb-item active" aria-current="page"><a
                href="{{ route('instructor.resource.show', $resource->id) }}">{{ $resource->title }}</a></li>
