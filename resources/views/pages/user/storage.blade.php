                            ...
                            <x-real.text-with-subtitle class="mt-2 border-bottom">
                                <x-slot name="text">
                                    ...
                                    @elseif(auth()->user()->isStorageReachingFull())
                                        <span
                                            class="position-absolute top-0 end-0 badge rounded-pill hstack text-muted gap-1">
                    ...
                    <x-real.tabcontent>
                        <x-real.tabpane :id="'CurrentStorage'" :active="true">
                            <div class="col-4 mb-1">
                                <input type="text" class="form-control" placeholder="Search Storage"
                                    id="storageSearch">
                            </div>
                            <div style="height: 800px" class="overflow-auto">
                                <div id="fm"></div>
                            </div>
                        </x-real.tabpane>
