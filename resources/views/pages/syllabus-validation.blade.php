               ...
               <x-real.card>
                  ...
                  <x-slot name="body">
                     <div class="gap-3 d-lg-grid">
                        ...
                        @else
                           <a id="createLessonsModalBtn" data-bs-toggle="modal" data-bs-target="#createLessonsModal"
                           ...
                           @if ($resource->hasMultipleMedia && $resource->verificationStatus == 'Pending')
                              <a href="{{ route('resource.createNewVersion', $resource) }}" id="submitAgainBtn"
                                 class="btn btn-secondary">
                                 Submit Again
                              </a>

                              <x-real.form method="PUT" action="{{ route('resource.cancelSubmission', $resource) }}">
                                 <x-slot name="submit">
                                    ...
                                    <div class="accordion-body p-0">
                                       <ul class="list-group nav nav-pills persist-default"
                                          ...
                                          <li class="nav-item list-group-item list-group-item-action p-0 border-0 border-bottom"
                                             role="presentation">
                                             <a href="#" class="hstack gap-3 py-0 border-0 nav-link rounded-0 active"
      ...
      <div class="col-lg-9">
         ...
         <x-real.tabcontent id="SyllabusValidation">
            <x-real.tabpane :id="'Validation'" :active="true">
               <div class="parentTabpane tab-pane fade show active" id="syllabusValidationTabpane-" role="tabpanel">
                  <x-real.card class="overflow-auto">
                     ...
                     <x-slot name="action">
                        <ul class="nav nav-pills gap-3" id="pills-tab-" role="tablist">
                           ...
                           <li class="nav-item p-0" role="presentation">
                              <a class="nav-link text-dark rounded-0 py-0" id="pills-profile-tab" data-bs-toggle="pill"
                                 data-bs-target="#pills-profile-" type="button" role="tab" aria-selected="false">Lesson
                                 Creation</a>
                           </li>
                        </ul>
                     </x-slot>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content rounded-6 shadow py-5 px-5">
               ...
               <div class="modal-body py-0">
                  <form id="lessonForm" action="{{ route('syllabi.confirmValidation', $resource) }}" method="POST"
                     class="row g-3">
                     @method('POST')
                     @csrf
