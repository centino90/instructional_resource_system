            ...
            <x-real.card :vertical="'center'" id="weeklySubmissionChartCard">
                ...
                <x-slot name="body">
                    <ul class="nav nav-pills nav-flush persist-default flex-column gap-2 bg-light">
                        ...
                        <li class="nav-item">
                            <a href="{{route('dean.submissions.course')}}" class="nav-link active">Course Submissions</a>
                        </li>
                        <li class="nav-item"><a href="{{route('dean.submissions.instructor')}}" class="nav-link">Instructor Submissions</a></li>
                    </ul>
                </x-slot>
            </x-real.card>
        </div>
