<x-app-layout>
    <x-slot name="breadcrumb">
        <x-breadcrumb>
            <li class="breadcrumb-item"><a href="{{ route('pending-resources.index') }}">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Pending Resources</li>
        </x-breadcrumb>
    </x-slot>
    ...
    <div class="row">
        ...
        {{-- MODAL FORMS --}}
        <div class="modal fade" id="saveResourceModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <small class="badge rounded-pill bg-success mx-1">{{ $activity->changes['attributes']['batch_id'] == $activities[0]->changes['attributes']['batch_id'] ? 'latest' : '' }}</small>
