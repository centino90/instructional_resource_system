    ...
    <div class="row">
        <div class="col-12">
            <x-card-body class="tab-content rounded-0 rounded-bottom border border-top-0 shadow-sm">
                ...
                <x-form-update action="{{ route('syllabi.update', $syllabus->resource_id) }}" id="syllabusForm">
                    <x-slot name="title">
                        Course Syllabus Edit Form
                    </x-slot>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="py-4 position-sticky start-0 top-0">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <a class="btn btn-warning form-control py-2"
                                            href="{{ route('syllabi.edit', $syllabus->resource_id) }}"
                                            onclick="return confirm('Are you sure you want to refresh this page? Confirming this will not save your changes')">
                            ...
                            <x-tab-pane :active="'true'" id="pills-home" aria-labelledby="pills-home-tab">
                                ...
                                <div class="row mb-3 mt-4 g-3">
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <x-input name="course_code" value="{{ $syllabus->course_code }}">
                                        </x-input>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <x-input name="course_title" value="{{ $syllabus->course_title }}">
                                        </x-input>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <x-input name="credit" value="{{ $syllabus->credit }}">
                                        </x-input>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <x-input name="time_allotment" value="{{ $syllabus->time_allotment }}">
                                        </x-input>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        ...
                                        <x-input name="professor" value="{{ $syllabus->professor }}">
                                        </x-input>
                                ...
                                <div class="row mb-3 mt-4">
                                    ...
                                    <div class="col-12" id="c-description-paragraph">
                                        @foreach ($syllabus->course_description['paragraphs'] as $row)
                                            <div class="row mb-3">
                                                <div class="col-12 col-lg-1">{{ $loop->index + 1 . '.' }}</div>

                                                <div class="col-12 col-lg-9 paragraph-input">
                                                    <x-input-textarea
                                                        name="course_description[paragraphs][{{ $loop->index }}]"
                                                        :error="'course_description.paragraphs.'.$loop->index"
                                                        :value="$row">

                                                    </x-input-textarea>

                                                    @error('course_description.paragraphs.' . $loop->index)
                                                        <x-input-error :for="'course_description.paragraphs.'.$loop->index">
                                                        </x-input-error>
                                                    @enderror
                                                </div>
                            ...
                            <x-tab-pane id="pills-profile" aria-labelledby="pills-profile-tab">
                                ...
                                <div class="row mb-3 mt-4">
                                    ...
                                    <div class="col-12" id="c-outcomes-paragraph">
                                        @foreach ($syllabus->course_outcomes['paragraphs'] as $row)
                                            <div class="row mb-3">
                                                <div class="col-12 col-lg-1">{{ $loop->index + 1 }}.</div>

                                                <div class="col-12 col-lg-9 paragraph-input">
                                                    <x-input-textarea
                                                        name="course_outcomes[paragraphs][{{ $loop->index }}]"
                                                        :error="'course_outcomes.paragraphs.'. $loop->index"
                                                        :value="$row">

                                                    </x-input-textarea>

                                                    @error('course_outcomes.paragraphs.' . $loop->index)
                                                        <x-input-error :for="'course_outcomes.paragraphs.'. $loop->index">
                                                        </x-input-error>
                                                    @enderror
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 my-3">
                                        ...
                                        <x-table id="c-outcomes-list">
                                            ...
                                            @foreach ($syllabus->course_outcomes['lists'] as $row)
                                                <tr class="ui-state-default">
                                                    <td class="col-1">{{ $loop->index + 1 }}.</td>

                                                    <td class="col-9">
                                                        <x-input name="course_outcomes[lists][{{ $loop->index }}]"
                                                            :error="'course_outcomes.lists.' . $loop->index"
                                                            value="{{ $row }}">
                                                        </x-input>

                                                        @error('course_outcomes.lists.' . $loop->index)
                                                            <x-input-error :for="'course_outcomes.lists.' . $loop->index">
                                                            </x-input-error>
                                                        @enderror
                                                    </td>
                            ...
                            <x-tab-pane id="pills-contact" aria-labelledby="pills-contact-tab">
                                ...
                                <div class="row mb-3 mt-4">
                                    ...
                                    <div class="col-12" id="l-outcomes-paragraph">
                                        @foreach ($syllabus->learning_outcomes['paragraphs'] as $row)
                                            <div class="row mb-3">
                                                <div class="col-12 col-lg-1">{{ $loop->index + 1 }}.</div>

                                                <div class="col-12 col-lg-9 paragraph-input">
                                                    <x-input-textarea
                                                        name="learning_outcomes[paragraphs][{{ $loop->index }}]"
                                                        :error="'learning_outcomes.paragraphs.'. $loop->index"
                                                        :value="$row">

                                                    </x-input-textarea>

                                                    @error('learning_outcomes.paragraphs.' . $loop->index)
                                                        <x-input-error :for="'learning_outcomes.paragraphs.'. $loop->index">
                                                        </x-input-error>
                                                    @enderror
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 my-3">
                                        ...
                                        <x-table id="l-outcomes-list">
                                            ...
                                            @foreach ($syllabus->learning_outcomes['lists'] as $row)
                                                <tr class="ui-state-default">
                                                    <td class="col-1">{{ $loop->index + 1 }}.</td>

                                                    <td class="col-9">
                                                        <x-input name="learning_outcomes[lists][{{ $loop->index }}]"
                                                            :error="'learning_outcomes.lists.' . $loop->index"
                                                            value="{{ $row }}">
                                                        </x-input>

                                                        @error('learning_outcomes.lists.' . $loop->index)
                                                            <x-input-error :for="'learning_outcomes.lists.' . $loop->index">
                                                            </x-input-error>
                                                        @enderror
                                                    </td>
            ...
            (function($) {
                ...
                function removeInputGroup() {
                    $('.remove-paragraph').click(function(e) {
                        ...
                        let conf = confirm('Are you sure you want to remove this paragraph?')
                        conf ? $(this).closest('.row').remove() : ''
                    })
                    $('.remove-list').click(function(e) {
                        e.preventDefault()

                        let conf = confirm('Are you sure you want to remove this list?')
                        conf ? $(this).closest('tr').remove() : ''
                    })
                }
